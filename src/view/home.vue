<template>
  <div>
    <!-- 首页 -->
    <div class="mihome" v-if="curtapbar === tapbars[0]">
      <div class="nav">
        <div class="user">
    ...
    <!-- 智能控制界面 -->
    <div v-else-if="curtapbar === tapbars[1]">smartSet</div>
    <!-- 用户界面 -->
    <div v-else>
      <keep-alive>
        <SignIn></SignIn>
